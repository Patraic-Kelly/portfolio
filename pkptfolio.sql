...
VALUES
	...
	('Da','Db','d@d.com','blablablabla',NOW(), 2),
	('Ea','Eb','e@e.com','blablablabla',NOW(), 2),
	('Fa','Fb','f@f.com','blablablabla',NOW(), 2),
	('Ga','Gb','g@g.com','blablablabla',NOW(), 3),
	('Ha','Hb','h@h.com','blablablabla',NOW(), 3),
	('Ia','Ib','i@i.com','blablablabla',NOW(), 4),
	('Ja','Jb','j@j.com','blablablabla',NOW(), 4),
	('Ka','Kb','k@k.com','blablablabla',NOW(), 4),
	('La','Lb','l@l.com','blablablabla',NOW(), 4),
	('Ma','Mb','m@m.com','blablablabla',NOW(), 4),
	('Na','Nb','o@o.com','blablablabla',NOW(), 5),
	('Oa','Ob','p@p.com','blablablabla',NOW(), 5),
	('Pa','Pb','q@q.com','blablablabla',NOW(), 5),
	('Qa','Qb','r@r.com','blablablabla',NOW(), 5),
	('Ra','Rb','s@s.com','blablablabla',NOW(), 5),
	('Sa','Sb','t@t.com','blablablabla',NOW(), 5),
	('Ta','Tb','u@u.com','blablablabla',NOW(), 5);